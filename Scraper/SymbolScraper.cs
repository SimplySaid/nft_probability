...
namespace Scraper
{
    public class SymbolScraper : ScraperBase
    {
        ...
        public SymbolScraper(IRpcClient client, ILogger logger, string name, string symbol, string address, string separator) : base(client, logger, name, symbol, address, separator)
        {
            _name = name;
            _symbol = symbol;
            _address = address;
